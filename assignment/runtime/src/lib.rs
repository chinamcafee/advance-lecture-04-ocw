...
/// For pallet-ocw-demo
impl pallet_ocw_dot_price::Trait for Runtime {
	type AuthorityId = pallet_ocw_dot_price::crypto::TestAuthId;
	type Call = Call;
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		OcwDemo: pallet_ocw_dot_price::{Module, Call, Storage, Event<T>},
	}
);
